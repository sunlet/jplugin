...
public final class ThreadFactoryBuilder {
    ...
    public ThreadFactoryBuilder setPriority(int priority) {
        ...
        AssertKit.assertTrue(priority >= Thread.MIN_PRIORITY);
        AssertKit.assertTrue(priority <= Thread.MAX_PRIORITY);
    ...
    public ThreadFactoryBuilder setUncaughtExceptionHandler(
        ...
        AssertKit.assertNotNull(uncaughtExceptionHandler, "handler");
    ...
    public ThreadFactoryBuilder setThreadFactory(
        ...
        AssertKit.assertNotNull(backingThreadFactory,"backFactory");
