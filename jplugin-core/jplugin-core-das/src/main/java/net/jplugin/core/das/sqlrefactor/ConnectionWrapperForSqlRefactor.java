 ...
 *
 */
public class ConnectionWrapperForSqlRefactor implements Connection {
	Connection inner = null;
	private String dataSourceName;

	ConnectionWrapperForSqlRefactor(String dsname, Connection i) {
		this.inner = i;
		this.dataSourceName = dsname;
	}
	//对于Statment方法，对于Statement在StatementWrapperForMt中处理
	public Statement createStatement() throws SQLException {
		return new StatementWrapperForSqlRefactor(this.dataSourceName,inner.createStatement());
	}

	public Statement createStatement(int resultSetType, int resultSetConcurrency) throws SQLException {
		return new StatementWrapperForSqlRefactor(this.dataSourceName,createStatement(resultSetType, resultSetConcurrency));
	}

	public Statement createStatement(int resultSetType, int resultSetConcurrency, int resultSetHoldability)
			throws SQLException {
		return new StatementWrapperForSqlRefactor(this.dataSourceName,inner.createStatement(resultSetType, resultSetConcurrency, resultSetHoldability));
	}

	//对于PrepareStatement直接在这里处理好
	public PreparedStatement prepareStatement(String sql, int resultSetType, int resultSetConcurrency,
			int resultSetHoldability) throws SQLException {
		sql = SqlRefactorManager.handleSql(this.dataSourceName,sql,inner);
