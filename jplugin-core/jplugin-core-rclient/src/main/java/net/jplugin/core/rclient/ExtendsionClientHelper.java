...
public class ExtendsionClientHelper {
	...
	public static void addClientProxyExtension(AbstractPlugin plugin,Class clazz,String url,String protocol){
		ObjectFactory fac = ObjectFactory.createFactory(ClientProxyDefinition.class)
				.property("protocol", protocol)
				.property("interf", clazz.getName())
				.property("url", url);
		plugin.addExtension(Extension.create(net.jplugin.core.rclient.Plugin.EP_CLIENT_PROXY,clazz.getName(),fac));
