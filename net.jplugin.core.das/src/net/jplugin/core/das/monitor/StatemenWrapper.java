...
public class StatemenWrapper implements PreparedStatement {
	...
	public ResultSet executeQuery() throws SQLException {
		return (ResultSet) SqlMonitor.execute(this, "executeQuery", 
				() -> ((PreparedStatement) inner).executeQuery());
	}

	public int executeUpdate() throws SQLException {
		return (int) SqlMonitor.execute(this, "executeUpdate", 
	...
	public boolean execute() throws SQLException {
		return (boolean) SqlMonitor.execute(this, "execute",  () -> ((PreparedStatement) inner).execute());
	}
	...
	public long executeLargeUpdate() throws SQLException {
		return (long) SqlMonitor.execute(this, "executeLargeUpdate", 
	...
	public boolean execute(String sql) throws SQLException {
		this.theSql = sql;
		return (boolean) SqlMonitor.execute(this, "execute",  () -> inner.execute(sql));
	}
	...
	public int[] executeBatch() throws SQLException {
		return (int[]) SqlMonitor.execute(this, "executeBatch",  () -> inner.executeBatch());
	}

	public boolean execute(String sql, String[] columnNames) throws SQLException {
		this.theSql = sql;
		return (boolean) SqlMonitor.execute(this, "execute",  () -> inner.execute(sql, columnNames));
	}
	...
	public ResultSet executeQuery(String sql) throws SQLException {
		this.theSql = sql;
		return (ResultSet) SqlMonitor.execute(this, "executeQuery",  () -> inner.executeQuery(sql));
	}

	public int executeUpdate(String sql) throws SQLException {
		this.theSql = sql;
		return (int) SqlMonitor.execute(this, "executeUpdate",  () -> inner.executeUpdate(sql));
	}
	...
	public int executeUpdate(String sql, int autoGeneratedKeys) throws SQLException {
		this.theSql = sql;
		return (int) SqlMonitor.execute(this, "executeUpdate", () -> inner.executeUpdate( sql,autoGeneratedKeys));
	}

	public int executeUpdate(String sql, int[] columnIndexes) throws SQLException {
		this.theSql = sql;
		return (int) SqlMonitor.execute(this, "executeUpdate",  () -> inner.executeUpdate(sql, columnIndexes));
	}

	public int executeUpdate(String sql, String[] columnNames) throws SQLException {
		this.theSql = sql;
		return (int) SqlMonitor.execute(this, "executeUpdate",  () -> inner.executeUpdate(sql, columnNames));
	}

	public boolean execute(String sql, int autoGeneratedKeys) throws SQLException {
		this.theSql = sql;
		return (boolean) SqlMonitor.execute(this, "execute",  () -> inner.execute(sql, autoGeneratedKeys));
	}

	public boolean execute(String sql, int[] columnIndexes) throws SQLException {
		this.theSql = sql;
		return (boolean) SqlMonitor.execute(this, "execute",  () -> inner.execute(sql, columnIndexes));
	}
	...
	public long[] executeLargeBatch() throws SQLException {
		return (long[]) SqlMonitor.execute(this, "executeLargeBatch",  () -> inner.executeLargeBatch());
	}

	public long executeLargeUpdate(String sql) throws SQLException {
		this.theSql = sql;
		return (long) SqlMonitor.execute(this, "executeLargeUpdate",  () -> inner.executeLargeUpdate(sql));
	}
	...
	public ResultSet getResultSet() throws SQLException {
		return SqlMonitor.getResultSet(this,()->inner.getResultSet());
	}
