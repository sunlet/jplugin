 ...
 *
 */
public class MaxAggFunction extends BaseMathAggFunctionHandler {
	...
	void aggrateValue(AggFunctionEvalueContext ctx, Class javaType, Object currentRowValue, int rowCount)
		...
		if (oldValue == null)
			...
			oldValue = max(javaType, oldValue, currentValue);

		ctx.setAttribute(OLD_VALUE, oldValue);
	}

	private Object max(Class javaType, Object a, Object b) throws SQLException {
